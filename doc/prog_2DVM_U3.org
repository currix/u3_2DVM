...
*** Programs \texttt{avec\_U3\_U2} and \texttt{avec\_U3\_SO3}
     The Programs ~avec_U3_XX~ compute the 2D Vibron Model energies and eigenstates using the XX chain for fixed parameters of -Eq. (\ref{ham2b}). 
     The input file is similar to the one in the last section:
