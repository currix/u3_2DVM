...
#
##    panel = pyplot.subplot(5, 5, basis_state/10+1)  ## Plot scan
...
##    pyplot.plot(time_grid,spb[basis_state+56,:],'g--') # SO(3) bis
##    pyplot.plot(time_grid,spb[basis_state-56,:],'c--') # U(2) bis
