PROGRAM avalavec_2DVM
  ...
  IF (Save_avec_Log) CALL SAVE_EIGENV_COMPONENTS(N_val, L_val, 999.0_DP, dim_block, "u2", Ham_matrix) ! 999.0 instead of xi. Needs to be fixed.
  !
  !    
  ! DEALLOCATE EIGENVALUES VECTOR
  DEALLOCATE(Eigenval_vector, STAT = IERR)    
